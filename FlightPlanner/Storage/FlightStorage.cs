    ...
    public static class FlightStorage
    {
        ...
        public static List<Airport> FindAirports(string userInput)
        {
            ...
            var fromAirport = _flights.Where(a =>
                ...
                a.From.Country.ToLower().Trim().Contains(userInput)).Select(a => a.From).ToList();
            var toAirport = _flights.Where(a =>
                a.To.AirportName.ToLower().Trim().Contains(userInput) ||
                a.To.City.ToLower().Trim().Contains(userInput) ||
                a.To.Country.ToLower().Trim().Contains(userInput)).Select(a => a.From).ToList();
